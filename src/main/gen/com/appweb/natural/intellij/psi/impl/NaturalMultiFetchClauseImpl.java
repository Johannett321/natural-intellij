...
public class NaturalMultiFetchClauseImpl extends ASTWrapperPsiElement implements NaturalMultiFetchClause {

  public NaturalMultiFetchClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitMultiFetchClause(this);
  }
