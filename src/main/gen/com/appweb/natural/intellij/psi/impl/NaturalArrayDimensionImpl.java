...
public class NaturalArrayDimensionImpl extends ASTWrapperPsiElement implements NaturalArrayDimension {

  public NaturalArrayDimensionImpl(@NotNull ASTNode node) {
    super(node);
  }
