...
public class NaturalEjectStatementImpl extends ASTWrapperPsiElement implements NaturalEjectStatement {

  public NaturalEjectStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitEjectStatement(this);
  }
