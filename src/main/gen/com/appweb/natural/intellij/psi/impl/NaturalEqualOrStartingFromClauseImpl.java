...
public class NaturalEqualOrStartingFromClauseImpl extends ASTWrapperPsiElement implements NaturalEqualOrStartingFromClause {

  public NaturalEqualOrStartingFromClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitEqualOrStartingFromClause(this);
  }
