...
public class NaturalStackStatementImpl extends ASTWrapperPsiElement implements NaturalStackStatement {

  public NaturalStackStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
