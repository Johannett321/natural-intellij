...
public class NaturalSubtractStatementImpl extends ASTWrapperPsiElement implements NaturalSubtractStatement {

  public NaturalSubtractStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
