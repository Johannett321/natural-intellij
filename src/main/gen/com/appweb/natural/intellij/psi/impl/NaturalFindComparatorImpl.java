...
public class NaturalFindComparatorImpl extends ASTWrapperPsiElement implements NaturalFindComparator {

  public NaturalFindComparatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitFindComparator(this);
  }
