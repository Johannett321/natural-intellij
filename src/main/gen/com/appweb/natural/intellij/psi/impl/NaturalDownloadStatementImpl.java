...
public class NaturalDownloadStatementImpl extends ASTWrapperPsiElement implements NaturalDownloadStatement {

  public NaturalDownloadStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDownloadStatement(this);
  }
