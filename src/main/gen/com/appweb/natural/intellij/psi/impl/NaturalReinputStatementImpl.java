...
public class NaturalReinputStatementImpl extends ASTWrapperPsiElement implements NaturalReinputStatement {

  public NaturalReinputStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitReinputStatement(this);
  }
