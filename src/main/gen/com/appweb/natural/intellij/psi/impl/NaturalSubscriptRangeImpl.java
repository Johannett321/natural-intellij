...
public class NaturalSubscriptRangeImpl extends ASTWrapperPsiElement implements NaturalSubscriptRange {

  public NaturalSubscriptRangeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSubscriptRange(this);
  }
