...
public class NaturalInputWindowClauseImpl extends ASTWrapperPsiElement implements NaturalInputWindowClause {

  public NaturalInputWindowClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitInputWindowClause(this);
  }
