...
public class NaturalRepeatConditionImpl extends ASTWrapperPsiElement implements NaturalRepeatCondition {

  public NaturalRepeatConditionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitRepeatCondition(this);
  }
