...
public class NaturalSkipStatementImpl extends ASTWrapperPsiElement implements NaturalSkipStatement {

  public NaturalSkipStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
