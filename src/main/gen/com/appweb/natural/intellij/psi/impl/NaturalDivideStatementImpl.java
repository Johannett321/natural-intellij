...
public class NaturalDivideStatementImpl extends ASTWrapperPsiElement implements NaturalDivideStatement {

  public NaturalDivideStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
