...
public class NaturalCompressStatementImpl extends ASTWrapperPsiElement implements NaturalCompressStatement {

  public NaturalCompressStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitCompressStatement(this);
  }
