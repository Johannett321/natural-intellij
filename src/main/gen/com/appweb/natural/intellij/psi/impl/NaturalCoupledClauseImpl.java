...
public class NaturalCoupledClauseImpl extends ASTWrapperPsiElement implements NaturalCoupledClause {

  public NaturalCoupledClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitCoupledClause(this);
  }
