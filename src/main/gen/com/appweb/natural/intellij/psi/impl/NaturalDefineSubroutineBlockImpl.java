...
public class NaturalDefineSubroutineBlockImpl extends ASTWrapperPsiElement implements NaturalDefineSubroutineBlock {

  public NaturalDefineSubroutineBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDefineSubroutineBlock(this);
  }
  ...
  @Override
  @Nullable
  public NaturalSubroutineName getSubroutineName() {
    return findChildByClass(NaturalSubroutineName.class);
  }
