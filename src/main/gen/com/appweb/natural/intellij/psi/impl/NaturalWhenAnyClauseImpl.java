...
public class NaturalWhenAnyClauseImpl extends ASTWrapperPsiElement implements NaturalWhenAnyClause {

  public NaturalWhenAnyClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitWhenAnyClause(this);
  }
