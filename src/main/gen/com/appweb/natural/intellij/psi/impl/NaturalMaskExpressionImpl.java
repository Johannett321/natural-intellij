...
public class NaturalMaskExpressionImpl extends ASTWrapperPsiElement implements NaturalMaskExpression {

  public NaturalMaskExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitMaskExpression(this);
  }
