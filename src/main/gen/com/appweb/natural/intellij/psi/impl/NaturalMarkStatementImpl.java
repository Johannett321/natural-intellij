...
public class NaturalMarkStatementImpl extends ASTWrapperPsiElement implements NaturalMarkStatement {

  public NaturalMarkStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitMarkStatement(this);
  }
