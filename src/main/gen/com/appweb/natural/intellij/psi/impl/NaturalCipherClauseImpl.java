...
public class NaturalCipherClauseImpl extends ASTWrapperPsiElement implements NaturalCipherClause {

  public NaturalCipherClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitCipherClause(this);
  }
