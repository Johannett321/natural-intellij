...
public class NaturalInputMarkClauseImpl extends ASTWrapperPsiElement implements NaturalInputMarkClause {

  public NaturalInputMarkClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitInputMarkClause(this);
  }
