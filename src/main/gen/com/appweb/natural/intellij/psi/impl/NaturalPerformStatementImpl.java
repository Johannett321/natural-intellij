...
public class NaturalPerformStatementImpl extends ASTWrapperPsiElement implements NaturalPerformStatement {

  public NaturalPerformStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public NaturalSubroutineRef getSubroutineRef() {
    return findChildByClass(NaturalSubroutineRef.class);
  }
