...
public class NaturalRangeSpecOption2Impl extends ASTWrapperPsiElement implements NaturalRangeSpecOption2 {

  public NaturalRangeSpecOption2Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitRangeSpecOption2(this);
  }
  ...
  public NaturalEqualOrStartingFromClause getEqualOrStartingFromClause() {
    return findChildByClass(NaturalEqualOrStartingFromClause.class);
  }
