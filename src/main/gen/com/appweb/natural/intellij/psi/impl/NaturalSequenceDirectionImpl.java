...
public class NaturalSequenceDirectionImpl extends ASTWrapperPsiElement implements NaturalSequenceDirection {

  public NaturalSequenceDirectionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSequenceDirection(this);
  }
