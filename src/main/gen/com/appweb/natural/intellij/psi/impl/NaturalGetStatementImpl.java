...
public class NaturalGetStatementImpl extends ASTWrapperPsiElement implements NaturalGetStatement {

  public NaturalGetStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitGetStatement(this);
  }
