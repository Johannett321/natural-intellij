...
public class NaturalSortGiveItemImpl extends ASTWrapperPsiElement implements NaturalSortGiveItem {

  public NaturalSortGiveItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSortGiveItem(this);
  }
