...
public class NaturalUnaryExprImpl extends ASTWrapperPsiElement implements NaturalUnaryExpr {

  public NaturalUnaryExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NaturalPrimary getPrimary() {
    return findNotNullChildByClass(NaturalPrimary.class);
  }
