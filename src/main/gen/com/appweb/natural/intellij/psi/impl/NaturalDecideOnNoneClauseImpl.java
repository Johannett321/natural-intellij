...
public class NaturalDecideOnNoneClauseImpl extends ASTWrapperPsiElement implements NaturalDecideOnNoneClause {

  public NaturalDecideOnNoneClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDecideOnNoneClause(this);
  }
