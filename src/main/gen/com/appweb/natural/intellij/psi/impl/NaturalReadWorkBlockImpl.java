...
public class NaturalReadWorkBlockImpl extends ASTWrapperPsiElement implements NaturalReadWorkBlock {

  public NaturalReadWorkBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitReadWorkBlock(this);
  }
