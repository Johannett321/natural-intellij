...
public class NaturalCallnatStatementImpl extends ASTWrapperPsiElement implements NaturalCallnatStatement {

  public NaturalCallnatStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitCallnatStatement(this);
  }
