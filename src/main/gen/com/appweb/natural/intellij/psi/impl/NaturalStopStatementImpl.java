...
public class NaturalStopStatementImpl extends ASTWrapperPsiElement implements NaturalStopStatement {

  public NaturalStopStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
