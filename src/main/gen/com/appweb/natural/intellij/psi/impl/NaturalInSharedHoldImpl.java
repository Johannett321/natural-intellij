...
public class NaturalInSharedHoldImpl extends ASTWrapperPsiElement implements NaturalInSharedHold {

  public NaturalInSharedHoldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitInSharedHold(this);
  }
