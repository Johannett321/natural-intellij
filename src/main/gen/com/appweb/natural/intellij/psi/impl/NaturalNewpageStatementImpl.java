...
public class NaturalNewpageStatementImpl extends ASTWrapperPsiElement implements NaturalNewpageStatement {

  public NaturalNewpageStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitNewpageStatement(this);
  }
