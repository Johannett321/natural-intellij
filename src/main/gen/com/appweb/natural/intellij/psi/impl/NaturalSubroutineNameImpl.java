...
import com.appweb.natural.intellij.psi.NaturalSubroutineNameMixin;
import com.appweb.natural.intellij.psi.*;

public class NaturalSubroutineNameImpl extends NaturalSubroutineNameMixin implements NaturalSubroutineName {

  public NaturalSubroutineNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSubroutineName(this);
  }
