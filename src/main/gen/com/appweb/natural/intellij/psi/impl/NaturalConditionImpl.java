...
public class NaturalConditionImpl extends ASTWrapperPsiElement implements NaturalCondition {

  public NaturalConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NaturalOrCondition getOrCondition() {
    return findNotNullChildByClass(NaturalOrCondition.class);
  }
