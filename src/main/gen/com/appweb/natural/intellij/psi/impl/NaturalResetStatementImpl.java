...
public class NaturalResetStatementImpl extends ASTWrapperPsiElement implements NaturalResetStatement {

  public NaturalResetStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitResetStatement(this);
  }
