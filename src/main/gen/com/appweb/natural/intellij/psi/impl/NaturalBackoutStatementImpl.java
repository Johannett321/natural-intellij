...
public class NaturalBackoutStatementImpl extends ASTWrapperPsiElement implements NaturalBackoutStatement {

  public NaturalBackoutStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitBackoutStatement(this);
  }
