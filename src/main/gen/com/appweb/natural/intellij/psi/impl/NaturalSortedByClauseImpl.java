...
public class NaturalSortedByClauseImpl extends ASTWrapperPsiElement implements NaturalSortedByClause {

  public NaturalSortedByClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSortedByClause(this);
  }
