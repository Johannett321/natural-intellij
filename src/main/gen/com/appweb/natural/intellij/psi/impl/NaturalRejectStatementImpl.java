...
public class NaturalRejectStatementImpl extends ASTWrapperPsiElement implements NaturalRejectStatement {

  public NaturalRejectStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitRejectStatement(this);
  }
