...
public class NaturalMoveStatementImpl extends ASTWrapperPsiElement implements NaturalMoveStatement {

  public NaturalMoveStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
