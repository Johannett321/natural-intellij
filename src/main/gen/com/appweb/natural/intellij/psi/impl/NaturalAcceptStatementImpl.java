...
public class NaturalAcceptStatementImpl extends ASTWrapperPsiElement implements NaturalAcceptStatement {

  public NaturalAcceptStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
