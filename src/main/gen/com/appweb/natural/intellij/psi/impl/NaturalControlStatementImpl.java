...
public class NaturalControlStatementImpl extends ASTWrapperPsiElement implements NaturalControlStatement {

  public NaturalControlStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
