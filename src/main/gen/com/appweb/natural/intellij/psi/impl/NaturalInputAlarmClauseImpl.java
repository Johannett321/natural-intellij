...
public class NaturalInputAlarmClauseImpl extends ASTWrapperPsiElement implements NaturalInputAlarmClause {

  public NaturalInputAlarmClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitInputAlarmClause(this);
  }
