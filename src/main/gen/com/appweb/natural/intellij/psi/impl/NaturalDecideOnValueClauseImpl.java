...
public class NaturalDecideOnValueClauseImpl extends ASTWrapperPsiElement implements NaturalDecideOnValueClause {

  public NaturalDecideOnValueClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDecideOnValueClause(this);
  }
