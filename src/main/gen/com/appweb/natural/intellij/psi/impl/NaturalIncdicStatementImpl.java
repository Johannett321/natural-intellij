...
public class NaturalIncdicStatementImpl extends ASTWrapperPsiElement implements NaturalIncdicStatement {

  public NaturalIncdicStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitIncdicStatement(this);
  }
