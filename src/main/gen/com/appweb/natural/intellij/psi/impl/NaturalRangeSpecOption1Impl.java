...
public class NaturalRangeSpecOption1Impl extends ASTWrapperPsiElement implements NaturalRangeSpecOption1 {

  public NaturalRangeSpecOption1Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitRangeSpecOption1(this);
  }
