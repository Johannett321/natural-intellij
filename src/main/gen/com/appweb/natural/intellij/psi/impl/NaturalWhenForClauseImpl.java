...
public class NaturalWhenForClauseImpl extends ASTWrapperPsiElement implements NaturalWhenForClause {

  public NaturalWhenForClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitWhenForClause(this);
  }
  ...
  public NaturalCondition getCondition() {
    return findNotNullChildByClass(NaturalCondition.class);
  }
