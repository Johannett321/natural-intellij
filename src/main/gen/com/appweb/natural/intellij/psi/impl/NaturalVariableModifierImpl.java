...
public class NaturalVariableModifierImpl extends ASTWrapperPsiElement implements NaturalVariableModifier {

  public NaturalVariableModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
