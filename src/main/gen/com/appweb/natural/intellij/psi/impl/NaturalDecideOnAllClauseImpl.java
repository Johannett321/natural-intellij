...
public class NaturalDecideOnAllClauseImpl extends ASTWrapperPsiElement implements NaturalDecideOnAllClause {

  public NaturalDecideOnAllClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDecideOnAllClause(this);
  }
