...
public class NaturalTranslateStatementImpl extends ASTWrapperPsiElement implements NaturalTranslateStatement {

  public NaturalTranslateStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitTranslateStatement(this);
  }
