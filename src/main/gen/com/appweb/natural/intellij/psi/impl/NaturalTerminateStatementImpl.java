...
public class NaturalTerminateStatementImpl extends ASTWrapperPsiElement implements NaturalTerminateStatement {

  public NaturalTerminateStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitTerminateStatement(this);
  }
