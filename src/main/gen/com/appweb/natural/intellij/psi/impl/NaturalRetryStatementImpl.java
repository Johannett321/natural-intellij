...
public class NaturalRetryStatementImpl extends ASTWrapperPsiElement implements NaturalRetryStatement {

  public NaturalRetryStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
