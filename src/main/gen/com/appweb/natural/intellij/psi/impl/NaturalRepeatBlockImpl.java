...
public class NaturalRepeatBlockImpl extends ASTWrapperPsiElement implements NaturalRepeatBlock {

  public NaturalRepeatBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NaturalRepeatCondition> getRepeatConditionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NaturalRepeatCondition.class);
  }
