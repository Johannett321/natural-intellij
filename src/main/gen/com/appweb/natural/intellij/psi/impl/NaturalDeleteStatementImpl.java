...
public class NaturalDeleteStatementImpl extends ASTWrapperPsiElement implements NaturalDeleteStatement {

  public NaturalDeleteStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
