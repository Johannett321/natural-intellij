...
import com.appweb.natural.intellij.psi.NaturalSubroutineRefMixin;
import com.appweb.natural.intellij.psi.*;

public class NaturalSubroutineRefImpl extends NaturalSubroutineRefMixin implements NaturalSubroutineRef {

  public NaturalSubroutineRefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSubroutineRef(this);
  }
