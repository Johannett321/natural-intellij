...
public class NaturalBreakConditionImpl extends ASTWrapperPsiElement implements NaturalBreakCondition {

  public NaturalBreakConditionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitBreakCondition(this);
  }
