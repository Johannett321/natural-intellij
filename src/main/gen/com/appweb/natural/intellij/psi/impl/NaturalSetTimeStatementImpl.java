...
public class NaturalSetTimeStatementImpl extends ASTWrapperPsiElement implements NaturalSetTimeStatement {

  public NaturalSetTimeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSetTimeStatement(this);
  }
