...
public class NaturalHistogramStatementImpl extends ASTWrapperPsiElement implements NaturalHistogramStatement {

  public NaturalHistogramStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitHistogramStatement(this);
  }
