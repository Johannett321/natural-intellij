...
public class NaturalMultiplyStatementImpl extends ASTWrapperPsiElement implements NaturalMultiplyStatement {

  public NaturalMultiplyStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
