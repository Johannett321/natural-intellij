...
public class NaturalDefineWindowStatementImpl extends ASTWrapperPsiElement implements NaturalDefineWindowStatement {

  public NaturalDefineWindowStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDefineWindowStatement(this);
  }
