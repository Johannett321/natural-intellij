...
public class NaturalOnErrorBlockImpl extends ASTWrapperPsiElement implements NaturalOnErrorBlock {

  public NaturalOnErrorBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitOnErrorBlock(this);
  }
