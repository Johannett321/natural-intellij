...
public class NaturalExamineStatementImpl extends ASTWrapperPsiElement implements NaturalExamineStatement {

  public NaturalExamineStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitExamineStatement(this);
  }
