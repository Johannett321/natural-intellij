...
public class NaturalFormatStatementImpl extends ASTWrapperPsiElement implements NaturalFormatStatement {

  public NaturalFormatStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitFormatStatement(this);
  }
