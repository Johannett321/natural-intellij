...
public class NaturalDefineWorkFileStatementImpl extends ASTWrapperPsiElement implements NaturalDefineWorkFileStatement {

  public NaturalDefineWorkFileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDefineWorkFileStatement(this);
  }
