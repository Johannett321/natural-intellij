...
public class NaturalWhenNoneClauseImpl extends ASTWrapperPsiElement implements NaturalWhenNoneClause {

  public NaturalWhenNoneClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitWhenNoneClause(this);
  }
