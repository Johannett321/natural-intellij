...
public class NaturalComputeStatementImpl extends ASTWrapperPsiElement implements NaturalComputeStatement {

  public NaturalComputeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
