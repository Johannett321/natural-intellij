...
public class NaturalIncludeStatementImpl extends ASTWrapperPsiElement implements NaturalIncludeStatement {

  public NaturalIncludeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
