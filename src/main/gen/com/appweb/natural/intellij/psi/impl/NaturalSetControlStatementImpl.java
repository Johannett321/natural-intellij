...
public class NaturalSetControlStatementImpl extends ASTWrapperPsiElement implements NaturalSetControlStatement {

  public NaturalSetControlStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSetControlStatement(this);
  }
