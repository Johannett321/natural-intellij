...
public class NaturalDefinePrinterStatementImpl extends ASTWrapperPsiElement implements NaturalDefinePrinterStatement {

  public NaturalDefinePrinterStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDefinePrinterStatement(this);
  }
