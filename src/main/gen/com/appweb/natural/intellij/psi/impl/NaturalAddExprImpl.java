...
public class NaturalAddExprImpl extends ASTWrapperPsiElement implements NaturalAddExpr {

  public NaturalAddExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NaturalMulExpr> getMulExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NaturalMulExpr.class);
  }
