...
public class NaturalCloseWorkStatementImpl extends ASTWrapperPsiElement implements NaturalCloseWorkStatement {

  public NaturalCloseWorkStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitCloseWorkStatement(this);
  }
