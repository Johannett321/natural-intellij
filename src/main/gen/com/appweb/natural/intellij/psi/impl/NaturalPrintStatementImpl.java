...
public class NaturalPrintStatementImpl extends ASTWrapperPsiElement implements NaturalPrintStatement {

  public NaturalPrintStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
