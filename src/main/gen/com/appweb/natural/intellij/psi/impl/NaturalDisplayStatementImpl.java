...
public class NaturalDisplayStatementImpl extends ASTWrapperPsiElement implements NaturalDisplayStatement {

  public NaturalDisplayStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
