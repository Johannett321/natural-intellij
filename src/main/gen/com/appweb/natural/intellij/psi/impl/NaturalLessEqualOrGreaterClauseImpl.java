...
public class NaturalLessEqualOrGreaterClauseImpl extends ASTWrapperPsiElement implements NaturalLessEqualOrGreaterClause {

  public NaturalLessEqualOrGreaterClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitLessEqualOrGreaterClause(this);
  }
