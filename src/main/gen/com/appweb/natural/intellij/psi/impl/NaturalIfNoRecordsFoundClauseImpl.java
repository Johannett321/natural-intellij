...
public class NaturalIfNoRecordsFoundClauseImpl extends ASTWrapperPsiElement implements NaturalIfNoRecordsFoundClause {

  public NaturalIfNoRecordsFoundClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitIfNoRecordsFoundClause(this);
  }
