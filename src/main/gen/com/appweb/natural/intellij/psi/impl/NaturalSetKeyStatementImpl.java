...
public class NaturalSetKeyStatementImpl extends ASTWrapperPsiElement implements NaturalSetKeyStatement {

  public NaturalSetKeyStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSetKeyStatement(this);
  }
