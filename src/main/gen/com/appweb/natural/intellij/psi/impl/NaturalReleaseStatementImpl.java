...
public class NaturalReleaseStatementImpl extends ASTWrapperPsiElement implements NaturalReleaseStatement {

  public NaturalReleaseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
