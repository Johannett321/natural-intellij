...
public class NaturalEscapeStatementImpl extends ASTWrapperPsiElement implements NaturalEscapeStatement {

  public NaturalEscapeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
