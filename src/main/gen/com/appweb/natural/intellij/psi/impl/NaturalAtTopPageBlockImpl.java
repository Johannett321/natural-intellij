...
public class NaturalAtTopPageBlockImpl extends ASTWrapperPsiElement implements NaturalAtTopPageBlock {

  public NaturalAtTopPageBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitAtTopPageBlock(this);
  }
