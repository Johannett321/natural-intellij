...
public class NaturalAssignStatementImpl extends ASTWrapperPsiElement implements NaturalAssignStatement {

  public NaturalAssignStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
