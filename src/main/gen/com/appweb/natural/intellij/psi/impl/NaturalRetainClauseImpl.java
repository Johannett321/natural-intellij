...
public class NaturalRetainClauseImpl extends ASTWrapperPsiElement implements NaturalRetainClause {

  public NaturalRetainClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitRetainClause(this);
  }
