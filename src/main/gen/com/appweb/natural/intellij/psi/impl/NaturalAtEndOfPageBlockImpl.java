...
public class NaturalAtEndOfPageBlockImpl extends ASTWrapperPsiElement implements NaturalAtEndOfPageBlock {

  public NaturalAtEndOfPageBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitAtEndOfPageBlock(this);
  }
