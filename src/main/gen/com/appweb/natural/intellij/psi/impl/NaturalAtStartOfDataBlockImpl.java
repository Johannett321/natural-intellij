...
public class NaturalAtStartOfDataBlockImpl extends ASTWrapperPsiElement implements NaturalAtStartOfDataBlock {

  public NaturalAtStartOfDataBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitAtStartOfDataBlock(this);
  }
