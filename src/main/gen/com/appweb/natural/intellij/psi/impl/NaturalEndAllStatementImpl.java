...
public class NaturalEndAllStatementImpl extends ASTWrapperPsiElement implements NaturalEndAllStatement {

  public NaturalEndAllStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitEndAllStatement(this);
  }
