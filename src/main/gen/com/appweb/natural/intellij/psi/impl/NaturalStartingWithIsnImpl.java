...
public class NaturalStartingWithIsnImpl extends ASTWrapperPsiElement implements NaturalStartingWithIsn {

  public NaturalStartingWithIsnImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitStartingWithIsn(this);
  }
