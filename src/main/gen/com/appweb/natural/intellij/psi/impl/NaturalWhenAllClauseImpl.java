...
public class NaturalWhenAllClauseImpl extends ASTWrapperPsiElement implements NaturalWhenAllClause {

  public NaturalWhenAllClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitWhenAllClause(this);
  }
