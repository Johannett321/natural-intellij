...
public class NaturalProcessCommandStatementImpl extends ASTWrapperPsiElement implements NaturalProcessCommandStatement {

  public NaturalProcessCommandStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitProcessCommandStatement(this);
  }
