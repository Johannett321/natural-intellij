...
public class NaturalIgnoreStatementImpl extends ASTWrapperPsiElement implements NaturalIgnoreStatement {

  public NaturalIgnoreStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
