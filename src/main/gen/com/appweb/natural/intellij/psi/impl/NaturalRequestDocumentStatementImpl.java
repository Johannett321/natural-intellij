...
public class NaturalRequestDocumentStatementImpl extends ASTWrapperPsiElement implements NaturalRequestDocumentStatement {

  public NaturalRequestDocumentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitRequestDocumentStatement(this);
  }
