...
public class NaturalSkipRecordsInHoldImpl extends ASTWrapperPsiElement implements NaturalSkipRecordsInHold {

  public NaturalSkipRecordsInHoldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSkipRecordsInHold(this);
  }
