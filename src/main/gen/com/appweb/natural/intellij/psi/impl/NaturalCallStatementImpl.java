...
public class NaturalCallStatementImpl extends ASTWrapperPsiElement implements NaturalCallStatement {

  public NaturalCallStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
