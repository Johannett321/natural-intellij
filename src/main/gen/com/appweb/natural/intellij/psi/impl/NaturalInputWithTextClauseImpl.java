...
public class NaturalInputWithTextClauseImpl extends ASTWrapperPsiElement implements NaturalInputWithTextClause {

  public NaturalInputWithTextClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitInputWithTextClause(this);
  }
