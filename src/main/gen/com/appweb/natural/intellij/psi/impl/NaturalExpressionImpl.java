...
public class NaturalExpressionImpl extends ASTWrapperPsiElement implements NaturalExpression {

  public NaturalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NaturalAddExpr getAddExpr() {
    return findNotNullChildByClass(NaturalAddExpr.class);
  }
