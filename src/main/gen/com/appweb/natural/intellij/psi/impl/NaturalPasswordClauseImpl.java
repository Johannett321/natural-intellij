...
public class NaturalPasswordClauseImpl extends ASTWrapperPsiElement implements NaturalPasswordClause {

  public NaturalPasswordClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
