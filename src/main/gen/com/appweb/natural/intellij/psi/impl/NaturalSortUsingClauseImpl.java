...
public class NaturalSortUsingClauseImpl extends ASTWrapperPsiElement implements NaturalSortUsingClause {

  public NaturalSortUsingClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitSortUsingClause(this);
  }
