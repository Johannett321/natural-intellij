...
public class NaturalDecideOnAnyClauseImpl extends ASTWrapperPsiElement implements NaturalDecideOnAnyClause {

  public NaturalDecideOnAnyClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitDecideOnAnyClause(this);
  }
