...
public class NaturalEndTransactionStatementImpl extends ASTWrapperPsiElement implements NaturalEndTransactionStatement {

  public NaturalEndTransactionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NaturalVisitor visitor) {
    visitor.visitEndTransactionStatement(this);
  }
